...
{
    public class OpenWindowsExecutor: IOutputActionExecutor
    {
        ...
        public OpenWindowsExecutor(IDateTimeProvider dateTimeProvider, IEventStoreClient eventStoreClient,
        ...
        public RuleOutputActionId OutputActionId => RuleOutputActionId.OpenWindows;
        ...
        public async Task<bool> Execute(long ruleId, RuleOutputAction outputAction, CancellationToken cancellationToken)
        {
            ...
            var commands = outputAction.Commands.Select(x => JsonSerializerHelpers.DeserializeFromObject<OpenWindowCommand>(x)).ToList();
